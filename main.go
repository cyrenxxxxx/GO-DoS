	...
	specs := []*utls.ClientHelloSpec{
		{ // Chrome 117 on Windows 10
			...
			Extensions: []utls.TLSExtension{
				&utls.SupportedVersionsExtension{[]uint16{utls.VersionTLS13, utls.VersionTLS12}},
				&utls.SupportedCurvesExtension{[]utls.CurveID{utls.X25519, utls.CurveP256, utls.CurveP384}},
				&utls.SignatureAlgorithmsExtension{[]utls.SignatureScheme{
		...
		{ // Firefox 117 on macOS
			...
			Extensions: []utls.TLSExtension{
				&utls.SupportedVersionsExtension{[]uint16{utls.VersionTLS13, utls.VersionTLS12}},
				&utls.SupportedCurvesExtension{[]utls.CurveID{utls.X25519, utls.CurveP256, utls.CurveP384, utls.CurveP521}},
				&utls.SignatureAlgorithmsExtension{[]utls.SignatureScheme{
					utls.ECDSAWithP256AndSHA256,
					utls.ECDSAWithP384AndSHA384,
