...
# Compile with optimization - GAMIT ANG SPECIFIED COMMAND
echo "Compiling with -D_GNU_SOURCE for CPU affinity..."
gcc -o main main.c -lssl -lcrypto -lnghttp2 -pthread -lm -O3 -D_GNU_SOURCE
